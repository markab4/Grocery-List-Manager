...
|9|Verify if user can add by picking item from a hierarchical list |Click into a list, click on the "add" icon on the top right, add it to the list|The selected item should appear in the list | The selected item in the hierarical list is add into the list | Pass ![#c5f015](https://placehold.it/15/c5f015/000000?text=+) | | 
