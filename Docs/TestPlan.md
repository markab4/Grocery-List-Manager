...
|16|Verify if user can add a specific type of items at once|Click into the list, click "add" icon, findthe type of item want to add, add all the item in that type into the list|All the item select to be add should appear on the list| |  | |
