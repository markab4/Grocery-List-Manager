...
|7|User is able to delete item from a list|Open a list, select an item, long press the item to delete| The item should disappear from the list|The selected item disappear from the list after long press| Pass ![#c5f015](https://placehold.it/15/c5f015/000000?text=+)| |
