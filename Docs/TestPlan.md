...
|4 |Verify if the list can be renamed|Select a list, click on the "pencil" icon, then a textbox called "Rename list" pop out, enter the new name in it, and click ok to save| The list should appear using its new name| List appeared in new name after rename it| Pass ![#c5f015](https://placehold.it/15/c5f015/000000?text=+) | |
...
|7|User is able to delete item from a list|Open a list, select an item, long press the item, click ok to delete| The item should disappear from the list|The selected item disappear from the list after click ok to agree to delete the item| Pass ![#c5f015](https://placehold.it/15/c5f015/000000?text=+)| |
|8 |Test if user can change quantity of an item on a list | Select the list which the item is in. Select the item that need to change quantity, click on the item quantity, a "Change Quantity" pop out, enter the new quantity | The quantity of the item changes when enter a new quantity in the pop out bar | After type in the new quantity, the item quantity in the list changed|Pass ![#c5f015](https://placehold.it/15/c5f015/000000?text=+) | | 
...
|11|Verify if user can find item by typing its name|Click into a list, click on the "add" icon, type into the name of the item| The item that user is looking for should appear and possible to be add in to the list| Able to find item in the database by type the name of the item in the search bar | Pass ![#c5f015](https://placehold.it/15/c5f015/000000?text=+) | |
|12|Verify if an item which is not in the hierarchical list can be add into it|Click into a list, click "add" icon, click once again on the "add" icon on the right top, a "Create new item" pop up, fill in the name and type of the item want to add to the data| The item should be add into the hierachical list| The item appear on the hierachical list and able to be add into the list | Pass ![#c5f015](https://placehold.it/15/c5f015/000000?text=+) | |
