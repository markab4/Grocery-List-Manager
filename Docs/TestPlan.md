...
|8 |Test if user can change quantity of an item on a list | Select the list in which the item is. Select the item that need to change quantity, click on the item quantity, a "Change Quantity" pop out, enter the new quantity | The quantity of the item changes when enter a new quantity in the pop out bar |Pass ![#c5f015](https://placehold.it/15/c5f015/000000?text=+) | | 
...
|12|Verify if an item which is not in the hierarchical list can be add into it|Click into a list, click "add" icon, select a type, click " custom item", type item name, click ok to add it into the list| The item should be add into the hierachical list| The item appear on the list | Pass ![#c5f015](https://placehold.it/15/c5f015/000000?text=+) | |
